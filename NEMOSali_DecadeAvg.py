...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov  9 08:47:34 2020
...
lat = np.array(saliA['LAT'].data)
depth = np.array(saliA['DEPTHT'].data)
...
for i in range(len(dsSaliA['SALINITY'])):
    if dsSaliA['SALINITY'][i].TIME_COUNTER.dt.year in range(1980,1990):
        A1980s.append(dsSaliA['SALINITY'][i].data)
    if dsSaliA['SALINITY'][i].TIME_COUNTER.dt.year in range(1990,2000):
        A1990s.append(dsSaliA['SALINITY'][i].data)
    if dsSaliA['SALINITY'][i].TIME_COUNTER.dt.year in range(2000,2010):
        A2000s.append(dsSaliA['SALINITY'][i].data)
    if dsSaliA['SALINITY'][i].TIME_COUNTER.dt.year in range(2010,2020):
        A2010s.append(dsSaliA['SALINITY'][i].data)
        
for i in range(len(dsSaliP['SALINITY'])):
    if dsSaliP['SALINITY'][i].TIME_COUNTER.dt.year in range(1980,1990):
        P1980s.append(dsSaliP['SALINITY'][i].data)
    if dsSaliP['SALINITY'][i].TIME_COUNTER.dt.year in range(1990,2000):
        P1990s.append(dsSaliP['SALINITY'][i].data)
    if dsSaliP['SALINITY'][i].TIME_COUNTER.dt.year in range(2000,2010):
        P2000s.append(dsSaliP['SALINITY'][i].data)
    if dsSaliP['SALINITY'][i].TIME_COUNTER.dt.year in range(2010,2020):
        P2010s.append(dsSaliP['SALINITY'][i].data)
...
tickslabels=np.arange(-0.4,0.405,0.05)
...
tickslabels=np.arange(-0.3,0.305,0.05)
norm=BoundaryNorm(tickslabels, len(tickslabels)-1)
